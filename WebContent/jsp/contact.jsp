...
<form action="../servlet/model" method="post">
	...
	<p>
		メルマガ種類：
		<input type="checkbox" name="info" value="総合案内">総合案内
		<input type="checkbox" name="info" value="セミナー案内">セミナー案内
		<input type="checkbox" name="info" value="求人採用情報">求人採用情報
	</p>

	<p>
		資料請求希望 <input type="radio" name="yesNo" value="yes">Yes
